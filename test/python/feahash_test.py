...
class Test4FeaHash(unittest.TestCase):
    ...
    def test_FeaRegister_GetSlotID(self):
        fea3val1_id: int = self.feahash.FeaRegister("fea3", "val1")
        ...
        fea10val1_id: int = self.feahash.FeaRegister("fea10", 3.14)
        ...
        fea11val1_id: int = self.feahash.FeaRegister("fea11", [1,2,3,4])
    ...
    def test_FeaRegister(self):
        fea1val1_id: int = self.feahash.FeaRegister("fea1", "2")[0]
        target: str = "10100025"
